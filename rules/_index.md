...
| 类别 | 数量 | 目录 | 执行方 |
|------|------|------|--------|
| 确定性规则 (Phase 1) | 23 | `deterministic/` | Checker（脚本执行）、Editor Mode 0、Detector、Writer |
| LLM 规则 (Phase 2) | 19 | `llm/` | Checker（语义判断） |
| AI 替换表 | 11 | `replacements/` | Reviser、Writer |
...
|------|---------|------|----------|
| `forbidden-patterns.yaml` | D001-D003, D022-D023 | 禁止句式、破折号、元叙事、明喻密度、编号式总结 | critical/warning |
...
| 文件 | 内容 |
|------|------|
| `ai-traces.yaml` | 11 条 AI 套话 → 人类表达替换 |
...
| **Supervisor** (Rule 6.5) | learned/ (写入) + replacements/ (追加) | AIGC Harness 规则沉淀 |
...
- 2026-04-03: D001 v2 扩展覆盖"不是不X，是Y"反标签句式
- 2026-04-03: 新增 D022 明喻密度、D023 编号式心理总结
- 2026-04-03: 替换表新增3条（反标签句式、编号总结、明喻过密）
- 2026-04-03: 新增 T019 感官聚焦技巧
- 2026-04-03: 新增 Rule 6.5 AIGC优化 Harness（沉淀规则到 learned/ + replacements/）
- 2026-04-03: Harness 首次沉淀 H001(对称式设定展示)、H002(三段式外貌模板)、H003(情绪总结过密)
- 2026-04-03: Harness Round 2 沉淀 H004(内感觉比喻)、H005(工整四步情绪结构)、H006(可信细节堆叠)
