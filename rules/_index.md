...
| 类别 | 数量 | 目录 | 执行方 |
|------|------|------|--------|
| 确定性规则 (Phase 1) | 19 | `deterministic/` | Checker（脚本执行）、Editor Mode 0、Detector、Writer |
...
| `statistics.yaml` | D016-D019 | TTR、句长std、段长std、主动句比例 | warning |
...
| **Detector** | deterministic/ (D001-D012, D016-D019) + replacements/ | AI 痕迹检测 |
